...
public class ReceiptsRecord extends UpdatableRecordImpl<ReceiptsRecord> implements Record6<Integer, Timestamp, String, BigDecimal, String, Integer> {
	...
	private static final long serialVersionUID = -395983421;
	 ...
	 */
	public ReceiptsRecord(Integer id, Timestamp uploaded, String merchant, BigDecimal amount, String tag, Integer receiptType) {
		super(Receipts.RECEIPTS);
